...
\justifying Оскільки з даних видно, що розподіл неперервний, то для побудови статистичного ряду дані з вибірки треба розбити на рівновеликі інтервали. Емпіричною формулою кількості таких інтервалів є формула Стерджеса:
...
\be\left\{\begin{array}{l}
  \lambda^*=\sqrt{\overline{\xi^2}-\overline{\xi}^2}\\
  a^*=\overline{\xi}-\sqrt{\overline{\xi^2}-\overline{\xi}^2}
\end{array}\right.\ee
